...
export const createProductView = (req, res, next) => {
    try {
...
export const deleteProduct = async (req, res, next) => {
    try {
        ...
        <div>
            <h4>
                The following premium product has been deleted: ${product.title}
            </h4>
        </div>`;
        if(product.premium) sendEmail(product.creator, 'Warning - Premium product deleted', contentEmail);
