...
export const deleteInoperantUsers = async (req, res, next) => {
    try {
        ...
        for (let index = 0; index < ids.length; index++) {
            ...
            if(hasPassed){
                ...
                <div>
                    <h4>
                        User ${user.email} has been deleted due to account inactivty.
                    </h4>
                </div>`
                await sendEmail(user.email, 'User deleted', content);
            }
        }
